...
<script>
import vueRemixicon from "../src/remixicon.js";
import { iconList, typeExceptions } from "../src/iconList.js";
  ...
  data() {
    return {
      ...
      rows: [
        ...
        { name: "container", type: "String", default: `div` },
