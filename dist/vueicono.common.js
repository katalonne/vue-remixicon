...
// EXTERNAL MODULE: ./node_modules/icono/dist/icono.min.css
var icono_min = __webpack_require__("749a");

// CONCATENATED MODULE: ./src/icono.js
...
/* harmony default export */ var icono = ({
  name: 'vue-icono',
  props: {
    name: {
      type: String,
  ...
  computed: {
    iconsNames: function iconsNames() {
  ...
  mounted: function mounted() {
    var iconExists = this.iconsNames.includes(this.name);
    if (!iconExists) throw new Error("[vue-icono]: Icon name \"".concat(this.name, "\" - not found"));
  },
  render: function render() {
    var h = arguments[0];
    var Container = this.container;
    return h(Container, {
      "class": "icono-".concat(this.name, " ").concat(this.className),
      "style": _objectSpread({
        color: this.color
      }, this.styles)
    });
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (icono);
...
/******/ })["default"];
//# sourceMappingURL=vueicono.common.js.map